...
try {
  ...
  let level6 = tronWeb.toDecimal(res[5]); // 3rd level downline
  let level7 = tronWeb.toDecimal(res[6]); // 1st level downline
  let level8 = tronWeb.toDecimal(res[7]); // 2nd level downline
  let level9 = tronWeb.toDecimal(res[8]); // 3rd level downline
  let level10 = tronWeb.toDecimal(res[9]); // 3rd level downline
  ...
  let level16 = tronWeb.toDecimal(res[15]); // 3rd level downline
  let level17 = tronWeb.toDecimal(res[16]); // 1st level downline
  let level18 = tronWeb.toDecimal(res[17]); // 2nd level downline
  let level19 = tronWeb.toDecimal(res[18]); // 3rd level downline
  let level20 = tronWeb.toDecimal(res[19]); // 3rd level downline
  ...
  $(".userRefsLevel16").html(level16);
  $(".userRefsLevel17").html(level17);
  $(".userRefsLevel18").html(level18);
  $(".userRefsLevel19").html(level19);
  $(".userRefsLevel20").html(level20);
  ...
  console.log("6th Level Downline:", level6);
  console.log("7th Level Downline:", level7);
  console.log("8th Level Downline:", level8);
  console.log("9th Level Downline:", level9);
  console.log("10th Level Downline:", level10);
  console.log("11th Level Downline:", level11);
  console.log("12th Level Downline:", level12);
  console.log("13th Level Downline:", level13);
  console.log("14th Level Downline:", level14);
  console.log("15th Level Downline:", level15);
  console.log("16th Level Downline:", level16);
  console.log("17th Level Downline:", level17);
  console.log("18th Level Downline:", level18);
  console.log("19th Level Downline:", level19);
  console.log("20th Level Downline:", level20);
